...
def process_song_file(cur, filepath):
    '''
    Processes all the song_data files.
    Params:
        - cur object:
            Database cursor.
        - filepath str:
            Files location for songs.
    '''
    # open song file
...
def process_log_file(cur, filepath):
    '''
    Processes all the log data files.
    Params:
        - cur object:
            Database cursor.
        - filepath str:
...
def process_data(cur, conn, filepath, func):
    '''
    Process data matching .json extension.
    Params:
        - cur object:
            Database cursor
        - conn object:
...
def main():
    conn = psycopg2.connect("host=127.0.0.1 dbname=sparkifydb user=dedwards")
    cur = conn.cursor()
